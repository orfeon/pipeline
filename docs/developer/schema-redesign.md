...
Phase 5 done except old-path removal (SchemaConfigUpgrader + MCP `upgrade-config` tool,
deprecation warnings in the validation-API response, migration guide at
`server/docs/module/common/schema-migration.md`; removing the legacy spellings stays scheduled
