...
public class ChangeSchemaTest {
    ...
    public void testFromSpannerRowType() {
        ...
        Assertions.assertEquals(ChangeSchema.TYPE_UUID, ChangeSchema.fromSpannerTypeCode("UUID"));
        Assertions.assertEquals("ARRAY<UUID>", ChangeSchema.fromSpannerTypeCode("{\"code\":\"ARRAY\",\"array_element_type\":{\"code\":\"UUID\"}}"));
