...
|------------------------------|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| project                      | String         | The project ID for your Google Cloud project. The project is required if you want to run your pipeline using the Dataflow managed service. When not set, it is resolved from the execution environment: the gcloud config, then the `GOOGLE_CLOUD_PROJECT` environment variable, then the GCE metadata server (Cloud Run / GCE). BigQuery query and load jobs, and the `datastore` sink, run in this project unless a more specific option (e.g. `bigquery.bigqueryProject`) is set. When running off Google Cloud (e.g. EMR), set this or the `GOOGLE_CLOUD_PROJECT` environment variable if any GCP module is used.                                                                                                       |
