...
| filter         | optional | [Filter](../common/filter.md)                           | Filter condition applied to the aggregation results (the equivalent of the [select](select.md) transform's `outputFilter`). Records that do not match are discarded.                          |
