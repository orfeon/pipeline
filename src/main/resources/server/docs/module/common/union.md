...
type: Common
title: Union
description: The union parameter shared by multi-input modules — merges inputs with different schemas into one schema via baseInput and field mappings.
tags: [common, union, schema, mapping]
