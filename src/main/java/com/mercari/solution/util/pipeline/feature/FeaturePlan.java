...
public class FeaturePlan implements Serializable {
    ...
    /**
     * One evaluation stage: the columns evaluated under one key in one pass (docs/developer/feature-engine.md §3.1).
    ...
    /**
     * A data audit query derived from the plan (docs/developer/feature-dsl.md §7): hot-key row counts per keyed stage so
