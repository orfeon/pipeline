 ...
 * sign agreement, a time window and leak-suspect flags. Outputs the scoring records (default output), one
 * {@code summary} record and, under {@code suggestions: true}, the {@code suggestions} records. Batch only.
 */
